...
$("#mobilenum").keyup(function() {
    if (mobilenum()) {
        $("mobilenum").css("border", "4px solid green");
        $("#messagemobilenum").html("<p class='text-success'>VALIDATED</p>")
    } else {
        $("#mobilenum").css("border", "4px solid red");
        $("#messagemobilenum").html("<p class='text-danger'>INVALID</p>")
    }
    buttonstate();
